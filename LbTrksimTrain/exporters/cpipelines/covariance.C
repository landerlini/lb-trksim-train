...
PIPELINE (covlong_pipe, covlong, covlong_tX, covlong_tY_inverse)   

PIPELINE (covupstream_pipe, covupstream, covupstream_tX, covupstream_tY_inverse)   

PIPELINE (covdownstream_pipe, covdownstream, covdownstream_tX, covdownstream_tY_inverse)   
